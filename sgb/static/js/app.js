$(document).ready(function() {
    ...
    /* Função para deixar o Fullcalendar em pt-br */
    ...
    /* id que permite chamar Fullcalendar no html */
...
// Configurações de Professor editar botão de impressão
...
// Configurações de Banca editar para botão de impressão
$('.dropdown-button3').dropdown({
    inDuration: 300,
    outDuration: 225,
    constrainWidth: true, // Does not change width of dropdown to that of the activator
    hover: false, // Activate on hover
    gutter: -38 , // Spacing from edge
    belowOrigin: false, // Displays dropdown below the button
    alignment: 'left', // Displays dropdown with edge aligned to the left of button
    stopPropagation: false // Stops event propagation
  }
...
// timepicker
  $('.timepicker').pickatime({
    default: '14:00', // Set default time: 'now', '1:30AM', '16:30'
